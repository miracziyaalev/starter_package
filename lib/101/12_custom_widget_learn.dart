...
class CustomFoodButton extends StatelessWidget with _PaddingUtility {
  CustomFoodButton({
    Key? key,
    required this.title,
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      child: Padding(
        ...
        child: Text(
          title,
          style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: _ColorsUtility().whiteColor),
        ),
      ),
    );
  }
